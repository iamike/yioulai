...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "ae_startup_edge.js"},
      { load: "ae_startup_edgeActions.js"}];
...
var plSTF="width",ctrPlS="horizontal",minPlW="0",maxPlW=undefined,plWidth="320px",plHeight="480px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['129', '231','62px','18px','auto', 'auto'],
